Public Class EditLevel
    ...
    Private Sub btnBrowseThumbnail_Click(sender As Object, e As EventArgs)
    ...
    Private Sub txtRank_KeyPress(sender As Object, e As KeyPressEventArgs)
        HanyaAngka(e)
    End Sub
